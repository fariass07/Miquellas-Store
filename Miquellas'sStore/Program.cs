...
class Estoque
{
    ...
    public void ProcessarCompras()
    {
        while (true)
        {
            ...
            double frete = CalcularFrete(jogo, quantidadeComprar, distancia);
            double precoFinal = PrecoFinal(jogo, quantidadeComprar, frete);
    ...
    public double CalcularFrete(Jogo jogo, int quantidade, double distancia)
    {
    ...
    public double PrecoFinal(Jogo jogo, int quantidade, double precoFrete)
    {
